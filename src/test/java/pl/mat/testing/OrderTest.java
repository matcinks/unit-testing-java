...
class OrderTest {
    ...
    void mealListShouldBeEmptyAfterCreationOfOrder() {
        ...
        //then
        assertThat(newOrder.getMeals(), empty());
        assertThat(newOrder.getMeals().size(), equalTo(0));
        assertThat(newOrder.getMeals(), hasSize(0));
        assertThat(newOrder.getMeals(), emptyCollectionOf(Meal.class));
